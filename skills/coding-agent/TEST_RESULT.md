...
Three comprehensive documents created in `skills/coding-agent/`:
...
4. **Safety rules to follow:**
   - Never use in your live OpenClaw directory (the running instance)
...
**Repository:** `skills/coding-agent/`  
**Files Modified:**
...
**Ready to commit to:** `skills/coding-agent/` in the OpenClaw repository
