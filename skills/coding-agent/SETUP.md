...
Do NOT checkout branches in `/home/dsauer/git/openclaw/` — that's the LIVE instance. Clone to temp folder instead.
...
| Item                 | Status       | Notes                                                   |
| -------------------- | ------------ | ------------------------------------------------------- |
| `claude` CLI         | ✅ Installed | `/home/dsauer/.local/bin/claude`                        |
| `codex` CLI          | ✅ Installed | `/home/dsauer/.npm-global/bin/codex`                    |
| `opencode` CLI       | ✅ Installed | `/home/dsauer/.opencode/bin/opencode`                   |
| `pi` CLI             | ✅ Installed | `/home/dsauer/.npm-global/bin/pi` (with prompt caching) |
